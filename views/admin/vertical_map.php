...
if (empty($mp_id)) {
    ...
    <script type="text/javascript">
        window.location.href = "<?php echo get_admin_url() ?>admin.php?page=wm_edit_website_map&mpid=<?php echo (int) $mp_id ?>";
    </script>
    <?php
}
...
$map['state_data'] = isset($map['state_data']) ? wm_sanitize_text_or_array_field($map['state_data']) : '';
$map['mp_tab_link'] =  '0';
...
<script type="application/javascript">
    ...
    if (state_record) {
        localStorage.setItem("demo_<?php echo (int)$mp_id; ?>", state_record);
    }
</script>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="number" class="form-control" name="mp_font_size"
                               value="<?php echo (int) $mp_font_size; ?>"><span style="font-size: 10px;"> default: 12px</span>
                    </div>
                </div>
